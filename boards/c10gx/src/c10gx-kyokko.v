...
//    c10gx_kyokko: Kyokko + Transceiver wrapper for Cyclone 10 GX Dev board
// ----------------------------------------------------------------------

`default_nettype none

module c10gx_kyokko # ( parameter NumCh=2 )
  ...
  c10_xcvr_2ch xcv
     ( .RST(RST | GT_RST), .USRCLK(CLK100), .REFCLK644P(CLK644P),
       .SFP_RXP(SFP_RXP),  .SFP_TXP(SFP_TXP),

       .TX_DATA  ({TXS[1], TXS[0]}),     
       .RX_DATA  ({RXS[1], RXS[0]}),
       .TX_CTRL  ({TXHDRi[1], TXHDRi[0]}), 
       .RX_CTRL  ({RXHDRi[1], RXHDRi[0]}),
