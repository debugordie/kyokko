...
//    hawkeye_kyokko: Kyokko + Transceiver wrapper for Gidel Hawkeye-40
// ----------------------------------------------------------------------

`default_nettype none

module hawkeye_kyokko # ( parameter NumCh=4 )
  ( input wire CLK125, RST,
   ...
   wire                        GT_RST;
   gt_rst grst
     ( .CLK(CLK125), .RST(RST), .GT_RST(GT_RST) );
  ...
  a10_xcvr_4ch xcv
     ( .RST(RST | GT_RST), .USRCLK(CLK125), .REFCLK644P(CLK644P),
