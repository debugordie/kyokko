...
//    au200_kyokko: Kyokko + GTY transceiver wrapper for Xilinx Alveo U200
// ----------------------------------------------------------------------
...
module au200_kyokko # 
  ...
  ( input wire CLK100, RST,
   ...
   wire                        GTREFCLK;
   IBUFDS_GTE4 refclkbuf
     ( .O(GTREFCLK),      .ODIV2(),                             // O
       .I(QSFP_REFCLKP),  .IB   (QSFP_REFCLKN), .CEB(1'b0) );  // I
   ...
   if (BondingEnable==0) begin : nobond_gt_gen
         ...
         if (ch%4 == 0) begin : w_qpll_gen
            ...
            gty_w_qpll gty_inst
              ( .gtwiz_userclk_tx_reset_in      (1'b0),              // I
                ...
                .gtyrxn_in                      (QSFP_RXN    [ch]),  // I
                .gtyrxp_in                      (QSFP_RXP    [ch]),  // I
                .rxgearboxslip_in               (RXSLIP      [ch]),  // I
                .txheader_in                    (TXHDR       [ch]),  // I [5:0]
                .txsequence_in                  (7'b0),              // I [6:0]
                .gtpowergood_out                (),                  // O
                .gtytxn_out                     (QSFP_TXN    [ch]),  // O
                .gtytxp_out                     (QSFP_TXP    [ch]),  // O
      ...
      for (ch=0; ch<NumCh; ch=ch+BondingCh) begin : gty_gen
         ...
         gty4 gty_inst
           ( .gtwiz_userclk_tx_reset_in     (1'b0),                // I
             ...
             .gtyrxn_in                     (QSFP_RXN[chE:ch]),    // I[3:0]
             .gtyrxp_in                     (QSFP_RXP[chE:ch]),    // I[3:0]
             .rxgearboxslip_in              (RXSLIP  [chE:ch]),    // I[3:0]
             .txheader_in                   (TXHDR   [chE:ch]),    // I[23:0]
             .txsequence_in                 (),                    // I[27:0]
             .gtytxn_out                    (QSFP_TXN[chE:ch]),    // O[3:0]
             .gtytxp_out                    (QSFP_TXP[chE:ch]),    // O[3:0]
