...
#
# This file is to:
#    Setup base project for Avnet KU040 DB, Kyokko on Dual SFP + Dual SMA
# ----------------------------------------------------------------------
...
set RTLs [ list \
               ${TOP}/boards/ku040/src/top.v \
               ${TOP}/boards/ku040/src/ku040-kyokko.v \
              ]
...
set XDCs [ list \
               ${TOP}/boards/ku040/src/ku040.xdc \
               ]
