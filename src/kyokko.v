...
module kyokko # ( parameter BondingEnable = 0, 
  ...
  ( input wire         CLK,   CLK100,
   ...
   wire                CB_ENABLEi = (BondingEnable==1) ? CB_ENABLE : 1;
   wire [4:0]          CB_STATi = (BondingEnable==1) ? CB_STAT : 'b1;
